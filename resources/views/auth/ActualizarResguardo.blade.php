...
@section('ActualizarResguardo')
<main class="content px-3 py-2">
    <div class="container-fluid">
        <div class="mb-3">
            <h4>Actualizar Resguardo</h4>
        </div>
        <!-- Table Element -->
        <div class="card border-0">
            <div class="card-header">
                <h5 class="card-title">
                    Actualizar Resguardo del Colaborador LUISA FERNANDA CASTRO MENDOZA
                </h5>
            </div>
            <div class="card-body">
                <table class="table">
                    <div class="row">
                        ...
                        <div class="col-3">
                            <form class="d-flex">
                                <input class="form-control form-control-sm me-2"
                                type="search" placeholder="DIRECCIÓN" aria-label="Search" style="width: 220px, 
                                height 150px">
                            </form>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-3">
                            <form class="d-flex">
                                <input class="form-control form-control-sm me-2"
                                type="search" placeholder="GERENCIA" aria-label="Search" style="width: 220px, 
                                height 150px">
                            </form>
                        </div>
                    </div>
