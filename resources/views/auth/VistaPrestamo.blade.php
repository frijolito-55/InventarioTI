    ...
    <div class="container-fluid">
        ...
        <div class="card border-0">
            <div class="card-body">
                ...
                <td class="text-center">
                    <a href="#" onclick="mostrarTablaFlotante()"
                        style="display: inline-block">
                        <i class="fa-solid fa-computer fa-2x"
                            style="margin-right: 10px; vertical-align: middle;"></i>
                    </a>
                </td>
                <td class="text-center">
                ...
                <!--TABLA FLOTANTE-->
                <div id="tablaFlotante" style="display: none; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); background-color: white; border: 1px solid #ccc; padding: 20px; max-width: 80%; max-height: 80%; overflow: auto;">
                    <h2>Tabla Flotante</h2>
