    ...
    <main class="content px-3 py-2">
        <div class="container-fluid">
            ...
            <div class="card border-0">
                        ...
                        <thead>
                            <tr>
                                <th scope="col">
                                    ...
                                    <select class="form-select" aria-label="size 3 select example" id="selecthotel"
                                        name="hotel">
                                ...
                                <th scope="col">
                                    <select class="form-select" aria-label="size 3 select example" id="selectTipo"
                                        name="tipo">
                                ...
                                <th scope="col">
                                    <select class="form-select" aria-label="size 3 select example" id="selectMarca"
                                        name="marca">
                                ...
                                <th scope="col">
                                    <select class="form-select" aria-label="size 3 select example" id="selectModelo"
                                        name="modelo">
                                        <option selected value="">MODELO</option>
                                    </select>
                                </th>
                                <th scope="col">
                                    <select class="form-select" aria-label="size 3 select example" id="selectEstado"
                                        name="estado">
                ...
                <!--ACA ESTARA EL NUMERO DE PAGINAS-->
